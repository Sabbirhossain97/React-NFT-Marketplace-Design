    ...
    <div>
      <div className="collection-container">
        <div class="collection-group1">
          <img
            src="assets/collection-big-image.png"
            width="400px"
            height="424px"
          />
        ...
        <div class="collection-group2">
          {[1, 2, 3].map((item, key) => (
            <div class="collection-group2-elements" key={key}>
              <img src={`assets/collection-image-${item}.png`} />
              <p class="collection-group2-text1">The Futr Abstr</p>
              <img src="assets/avatar1.png" class="collection-group2-avatar" />
              <div class="collection-group2-frame">
                <img src="assets/ethereum2.png" />
        ...
        <div class="collection-group3">
          ...
          <div class="collection-group3-elements">
            ...
            <img
              ...
              src="assets/top-collections/ethereum-big.png"
            />
            <p class="collection-group3-elements-name">CryptoFunks</p>
            <img
              src="assets/top-collections/cryptofunks.png"
            ...
            <img src="assets/top-collections/verify.png" class="verify"/>
          </div>
          <div class="collection-group3-elements">
            {" "}
            ...
            <img
              src="assets/top-collections/cryptix.png"
              class="collection-group3-elements-logo"
            />
          ...
          <div class="collection-group3-elements">
            ...
            <img
              src="assets/top-collections/frensware.png"
              class="collection-group3-elements-logo"
            />
          ...
          <div class="collection-group3-elements">
            ...
            <img
              src="assets/top-collections/punkart.png"
              class="collection-group3-elements-logo"
            />
          ...
          <div class="collection-group3-elements" style={{border: "none"}}>
            ...
            <img
              src="assets/top-collections/artcrypto.png"
              class="collection-group3-elements-logo"
            />
